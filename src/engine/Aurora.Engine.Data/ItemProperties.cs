...
namespace Aurora.Engine.Data
{
    public class ItemProperties
    {
        ...
        {
            get { return properties.Get(ElementStrings.Properties.ItemStackable, false); }
            //set { properties[ElementStrings.Properties.ItemStackable] = value; }
        }

        public decimal WeightValue
        {
            get { return properties.Get(ElementStrings.Properties.ItemWeight, 0); }
            //set { properties[ElementStrings.Properties.ItemWeight] = value; }
        }

        public string WeightUnit
        {
            get { return properties.Get(ElementStrings.Properties.ItemWeightUnit, string.Empty); }
            //set { properties[ElementStrings.Properties.ItemWeightUnit] = value; }
        }

        public bool WeightIgnore
        {
            get { return properties.Get(ElementStrings.Properties.ItemWeightIgnore, false); }
            //set { properties[ElementStrings.Properties.ItemWeightUnit] = value; }
        }

        public int Cost
        {
            get { return properties.Get(ElementStrings.Properties.ItemCost, 0); }
            //set { properties.Set(ElementStrings.Properties.ItemCost, value); }
        }

        public string CostCurrency
        {
            get { return properties.Get(ElementStrings.Properties.ItemCostCurrency, ElementStrings.Properties.ItemCostCurrencyDefault); }
            //set { properties.Set(ElementStrings.Properties.ItemCostCurrency, value); }
        }

        public string Rarity
        {
            get { return properties.Get(ElementStrings.Properties.ItemRarity, ""); }
